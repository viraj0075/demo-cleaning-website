  ...
  const services = [
    {
      ...
      desc: "Standard dusting, mopping & vacuuming.",
    },
    {
      id: "premium",
      name: "Premium Clean",
      ...
      desc: "Standard details plus oven & interior fridge.",
    },
    {
      id: "office",
      name: "Office Clean",
      ...
      desc: "Tailored commercial schedules & workspaces.",
    },
    {
      id: "deep",
      name: "Deep / Spring",
      ...
      desc: "Detailed scrub & post-move sanitizing.",
    },
    {
      id: "carpet",
      name: "Carpet & Window",
      ...
      desc: "Steam carpet extraction & streak-free windows.",
    },
  ];
      ...
      <div className="pt-28 sm:pt-32 pb-16 sm:pb-20 bg-gray-50/50 min-h-screen flex items-center justify-center px-4">
        <div className="max-w-xl w-full bg-white rounded-2xl shadow-famic-lg border border-gray-100 p-6 sm:p-8 md:p-12 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl sm:text-3xl font-black text-green-medium">
              Booking Request Sent!
            </h2>
            <p className="text-gray-500 text-xs sm:text-sm md:text-base leading-relaxed">
              Thank you,{" "}
              <span className="font-bold text-green-medium">{fullName}</span>.
              We have sent a confirmation email to{" "}
              <span className="font-semibold text-green-medium">{email}</span>.
              Our team will contact you shortly at{" "}
              <span className="font-semibold text-green-medium">{phone}</span>.
            </p>
          </div>

          {/* Booking Summary Box */}
          <div className="bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-100 text-left space-y-3.5">
            <h3 className="font-bold text-green-medium text-xs sm:text-sm border-b border-gray-200 pb-2 uppercase tracking-wider">
              Cleaning Summary
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 text-xs sm:text-sm">
              ...
              <span className="text-green-medium font-semibold sm:text-right">
                {fullName}
              </span>

              <span className="text-gray-400">Email:</span>
              <span className="text-green-medium font-semibold sm:text-right truncate">
                {email}
              </span>
            ...
            <div className="border-t border-gray-200 pt-3 flex justify-between items-baseline">
              <span className="text-green-medium font-extrabold text-sm sm:text-base">
                Booking Cost:
              </span>
              <span className="text-green-dark font-black text-xl sm:text-2xl">
                ${estimatedCost}/mo
              </span>
            </div>
          </div>
    ...
    <div className="pt-24 sm:pt-28 pb-16 sm:pb-20 bg-gray-50/50 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10 space-y-2.5 sm:space-y-3">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-green-medium tracking-tight">
            Book Your Cleaning
          </h1>
          <p className="text-gray-500 text-xs sm:text-sm font-semibold max-w-lg mx-auto">
            Enter your details below to schedule your cleaning package
            instantly.
          </p>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-8 bg-white rounded-2xl p-4 sm:p-6 md:p-8 border border-gray-100 shadow-famic-md space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-3">
                <h3 className="text-base sm:text-lg font-extrabold text-green-medium">
                  1. Select Service Plan
                </h3>
                <p className="text-gray-400 text-[11px] mt-0.5 font-medium">
                  Choose a service tier that fits your needs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {services.map((srv) => (
                  <div
                    ...
                    className={`p-4 rounded-xl border-2 cursor-pointer transition-all flex flex-col justify-between h-36 text-left group ${
                      cleaningType === srv.id
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="font-black text-green-medium text-base sm:text-lg">
                        {srv.price}
                      </span>
                    </div>
                    <div>
                      <h4 className="font-extrabold text-green-medium text-xs sm:text-sm leading-snug">
                        {srv.name}
                      </h4>
            ...
            <div className="space-y-5">
              <div className="border-b border-gray-100 pb-3">
                ...
                <p className="text-gray-400 text-[11px] mt-0.5 font-medium">
                  Please enter your contact and cleaning location details.
                </p>
              </div>
          ...
          <div className="lg:col-span-4 bg-white border border-gray-200/80 rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-xl space-y-5 sm:space-y-6">
            <h3 className="font-black text-gray-950 text-base pb-3 border-b border-gray-100">
            ...
            <div className="bg-[#0A1F1C] text-white p-5 sm:p-6 rounded-2xl border border-white/10 flex flex-col items-center justify-center gap-1 text-center shadow-lg">
              ...
              <span className="text-white/60 text-[10px] font-medium mt-1">
                Taxes & fees included. Cancel for free.
              </span>
            </div>
